...
- ***Autoscaling, service discovery, репликация***
    - Используем ***встроенные возможности*** ***горизонтального масштабирования*** выбранных распределенных хранилищ(Elastic Search, MongoDB) - данные stateless-компоненты размещены вне кластера Kubernetes
